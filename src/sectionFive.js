export default function sectionFive() {
    ...
    section.setAttribute('id', 'sectionFive');
    ...
    img.src = "./img/sectionFive.jpeg";
    img.style.height = "32rem";
    img.style.width = "28rem";
    img.style.margin = "90px 50px";

    //right side with text and a link
    const paraBox = document.createElement('div');
    section.appendChild(paraBox);
    const para1 = document.createElement('p');
    paraBox.appendChild(para1);
    para1.textContent = "Vermouth is the typical accompaniment to tapas and we invite you to sample our extensive and surprising list."
    const para2 = document.createElement('p');
    paraBox.appendChild(para2);
    para2.textContent = "In addition, we offer craft beer, Spanish and American wines, a full bar and a variety of delightful non-alcoholic options."
    ...
    paraBox.style.marginRight = "50px";
